...
今日 AI 资讯聚焦开发生态 Codex 的重要功能更新与性能优化。

**关键内容：**
* **Codex 版本更新**：新增自定义快捷键与 Git 优化功能，并实现大幅性能提升。
* **性能修复**：Codex 已成功修复此前存在的 GPT-5.5 性能下降问题。

---

## 📡 橘鸦AI早报

### [2026-05-17](https://imjuya.github.io/juya-ai-daily/issue-93/)

- **来源**: 橘鸦AI早报
- **发布时间**: 2026-05-17 01:06
...
- [https://mp.weixin.qq.com/s/H8D6ClBheNj3a\_Au-4LKQg](https://mp.weixin.qq.com/s/H8D6ClBheNj3a_Au-4LKQg)
