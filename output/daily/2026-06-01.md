...
今日 AI 资讯聚焦大模型性能突破，MiniMax 发布支持超长上下文的新一代多模态模型。

- **MiniMax 发布 M3 模型**：新模型支持多模态能力，并具备高达 1M（百万）级别的超长上下文处理能力。
- **行业动态**：AI 早报视频版已同步更新，持续关注模型发布及 SpaceXAI 等前沿趋势。
...
### [2026-06-01](https://imjuya.github.io/juya-ai-daily/issue-108/)

- **来源**: 橘鸦AI早报
- **发布时间**: 2026-06-01 00:44
...
- [https://modelscope.cn/brand/view/AI\_PC?branch=0&tree=1](https://modelscope.cn/brand/view/AI_PC?branch=0&tree=1)
