...
**DeepSeek 宣布将 V4-Pro API 的 2.5 折优惠转为永久定价，持续降低开发者使用成本。**

* **核心动态**：DeepSeek 针对其高性能模型 DeepSeek-V4-Pro API 实施重大定价调整。
* **关键变化**：原有的 2.5 折限时优惠将不再是短期促销，而是直接转为永久性的价格策略。
* **趋势观察**：此举体现了高性能大模型定价向长期低价化发展的趋势，有助于降低 AI 应用的开发与落地门槛。

---

## 📡 橘鸦AI早报

### [2026-05-23](https://imjuya.github.io/juya-ai-daily/issue-99/)

- **来源**: 橘鸦AI早报
- **发布时间**: 2026-05-23 01:19
...
- [https://x.com/deepseek\_ai/status/2049312932014813344](https://x.com/deepseek_ai/status/2049312932014813344)
