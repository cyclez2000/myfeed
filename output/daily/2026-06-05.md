...
今日 AI 领域呈现出模型迭代加速与行业格局调整的双重趋势。

**关键内容：**

* **模型动态**：NVIDIA 正式发布并开源 Nemotron 3 Ultra 模型；OpenAI 发布最新 ChatGPT。
* **人物动态**：Mira Murati 采取审慎策略重新进入公众视野，寻求在当前 AI 环境下的影响力。
* **开发者支持**：Meta 为已停产的 Portal 设备开启 ADB 权限，允许开发者继续为这些旧设备构建应用。
...
### [2026-06-05](https://imjuya.github.io/juya-ai-daily/issue-112/)

- **来源**: 橘鸦AI早报
- **发布时间**: 2026-06-05 01:08
...
Comments URL: [https://news.ycombinator.com/item?id=48406640](https://news.ycombinator.com/item?id=48406640)
