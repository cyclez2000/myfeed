...
Cohere 正式进军编程模型领域，发布其首个专用模型 BLS-Mini-Code-1.0。

* **新模型发布**：Cohere 推出了其首款编程专用模型 BLS-Mini-Code-1.0。
* **开源趋势**：该模型已发布早期权重，显示出研究团队在推动编程模型开源化方面的最新进展。

---

## 📡 橘鸦AI早报

### [2026-06-07](https://imjuya.github.io/juya-ai-daily/issue-114/)

- **来源**: 橘鸦AI早报
- **发布时间**: 2026-06-07 00:58
...
- [https://www.reddit.com/r/LocalLLaMA/comments/1tylzy2/coheres\_unreleased\_coding\_model\_early\_access\_for/](https://www.reddit.com/r/LocalLLaMA/comments/1tylzy2/coheres_unreleased_coding_model_early_access_for/)
